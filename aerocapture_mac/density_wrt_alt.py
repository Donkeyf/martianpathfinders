...
def mars_atmosphere_model(h):
    ...
    if  h < 39000:
        ...
        temp = np.float128(-2.55314E-10 * z ** 5 + 2.31927E-07 * z **4 - 8.33206E-05 * z ** 3 + 0.0151947 * z ** 2 - 1.52799 * z + 48.69659)
        return np.exp(temp)
    elif 200000 <= h < 300000:
        temp = np.float128(2.65472E-11 * z ** 5 - 2.45558E-08 * z **4 + 6.31410E-06 * z ** 3 + 4.73359E-04 * z ** 2 - 0.443712 * z + 23.79408)
        return np.exp(temp)
    else:
        P = 0
        T = 1
