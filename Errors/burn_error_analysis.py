...
def burnError(p_A,p_B, mu, ut1, d1, m1, y1, ut2, d2, m2, y2, r_p_A, v_hyp_A, v_park_A):
    ...
    ta, a, peri, r_A_vec, v_r, v_n, v = kp.tle_orbit(t,mu_s,i,raan,e,argp,ma,n)
    ...
    ta, a, peri, r_B_vec, v_r, v_n, v = kp.tle_orbit(t,mu_s,i,raan,e,argp,ma,n)

    # Propagate target transfer
    h, e, a, T, n, i, raan, argp, ta, ma = foe.find_orbital_elements(r_A_1,v_dep_A,MU_SUN)
    ta, a, peri, r_transfer, v_r, v_n, v = kp.tle_orbit(t,mu_s,i,raan,e,argp,ma,n)
    ...
    ax.set_aspect('equal')
    kp.set_aspect_equal(ax,r_A_vec[0]/1000000000.0,r_A_vec[1]/1000000000.0,r_A_vec[2]/1000000000.0)
