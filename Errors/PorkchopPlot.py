...
class PorkchopPlot:
    ...
    def get_plot(self):
        ...
        ax1.scatter(self.depart_dates,self.arrive_dates,c=np.log(self.new_dvs),s=100)
    ...
    def plot_3D(self):
        ...
        ax.scatter(self.jd_1s/(60.0*60*24),self.jd_2s/(60.0*60*24),self.dvs,c=np.log(self.dvs))
